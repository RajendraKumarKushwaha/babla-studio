...
export default function HeaderPage1() {
    ...
    return (
        <header className="w-full uppercase mb-[45px] header  text-[#000000]">
            {/* Desktop Layout */}
            <div className="hidden lg:flex flex-col items-center justify-center text-[#222222]  px-4 py-6 gap-6">
                {/* Logo Centered */}
                <img src="/images/demologo.png" className="w-30" alt="logo" />
                ...
                <div className="flex gap-23 text-[13px]">
                    ...
                    <Link className="hover:text-[#B3B3B3]" href="/contact-us">Contact Us</Link>
                    {/* <a
            ...
            <div className={`fixed top-0 left-0 h-full w-64 bg-[#f5f1eb] shadow-md transform transition-transform duration-300 z-50 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <nav className="flex flex-col text-[13px] gap-4 px-6 py-6 bg-[#f5f1eb] text-[#222222]">
